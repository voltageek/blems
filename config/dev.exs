...
config :portal, PortalWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "w5EmfEOgIRdP6wrK2Qtyhz8/fGSR/ITJ9ma/uhDHIzw3HQEtuE6NyWrxe9zVLZk7",
  watchers: [
...
config :api, ApiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yEundllFqvwU/E0/ScZoMjOOihA/k739dhTt8g4Cfyz3e3cKXC9pdNHxHhtdFXDH",
  watchers: [
  ]
...
config :admin, AdminWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/31+m5a0GyFKjOstHl9wYr1syPEbWLXceYYCCAuqNTElApcow0lDPF9NuIj0i1Iv",
  watchers: [
